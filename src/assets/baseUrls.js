...
export function baseURL () {
    ...
    // 注册协议
        ...
        URL_WX: `https://open.weixin.qq.com/connect/oauth2/authorize?appid=${global.APPID}&redirect_uri=${global.redirect}?redirectUrl=${global.redirectUrlBase64}&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect`,
        // 支付宝授权地址
