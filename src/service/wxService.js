import {getWxSign, share} from '@api/WXService.js'
  ...
  return new Promise((resolve) => {
      wx.config({
        ...
        signature: result.signature, // 必填，签名
		    jsApiList: ['onMenuShareAppMessage', 'onMenuShareTimeline', 'onMenuShareQQ', 'onMenuShareWeibo', 'onMenuShareQZone', 'chooseWXPay'] // 必填，需要使用的JS接口列表
      })
      wx.ready(function () {
            resolve()
      })
